...
const CartItems = () => {
   ...
   //  console.log(items, "cart items ererererer")
   const items:any[] = []
  return (
    items.length > 0 ? (
        ...
        <div className='bg-gray-100 px-5 py-3'>
             <div className='flex items-center justify-between'>
                  ...
                  <p className='text-[#333] font-normal '>54 produits</p>
             </div>
             {/* cart items */}
      ...
      <p className='text-sm text-gray-400 font-normal  '>Vendeur GARNIER</p>
      ...
      <div className='flex flex-col items-end '>
         <h3 className='text-2xl font-extrabold text-[#111] '>{item.price} Dh</h3>
      ...
      <div className='flex flex-col items-end '>
         <h3 className='text-[16px] font-semibold text-[#111] '>{item.price} Dh</h3>
         <p className='text-gray-400 line-through text-sm font-normal '>1 299,00 Dh</p>
      </div>
      </div>
      </div>
